...
export function SlackPage() {
  ...
  const messages: Message[] = [
    { id: "1", channel: "#engineering", preview: "Just merged the authentication refactor PR...", time: "10m ago", replies: 3 },
    { id: "2", channel: "#product", preview: "Updated the roadmap for Q2, check it out...", time: "45m ago", replies: 7 },
    { id: "3", channel: "#design", preview: "New mockups for the dashboard are ready...", time: "1h ago", replies: 12 },
    { id: "4", channel: "#engineering", preview: "Anyone available to review my PR?", time: "2h ago", replies: 2 },
    { id: "5", channel: "#random", preview: "Great team lunch today! 🍕", time: "3h ago", replies: 15 },
    { id: "6", channel: "#product", preview: "Customer feedback summary for last week...", time: "4h ago", replies: 5 },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'var(--zen-blue)' }}>
        ...
        >
          ...
          <div className="p-6 rounded-2xl" style={{ backgroundColor: 'white' }}>
            ...
            <p className="text-3xl" style={{ color: 'var(--zen-charcoal)', fontWeight: 300 }}>{stats.mentions}</p>
          </div>
        </motion.div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-sm" style={{ color: 'var(--zen-blue)' }}>
                          {message.channel}
                        </span>
                      ...
                      <p className="mb-2 line-clamp-2" style={{ color: 'var(--zen-charcoal)' }}>
                        {message.preview}
                      </p>
                      <div className="flex items-center gap-1 text-sm" style={{ color: 'var(--zen-charcoal-light)' }}>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span style={{ color: 'var(--zen-charcoal)' }}>{channel.name}</span>
                    </div>
                    <span className="text-sm" style={{ color: 'var(--zen-charcoal-light)' }}>
                      {channel.messages}
                    </span>
                  ...
                  <div className="h-2 rounded-full overflow-hidden" style={{ backgroundColor: 'var(--zen-sand-light)' }}>
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${(channel.messages / topChannels[0].messages) * 100}%` }}
            ...
            <div className="pt-4 border-t" style={{ borderColor: 'var(--zen-sand)' }}>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span style={{ color: 'var(--zen-charcoal-light)' }}>Most active time</span>
                  <span style={{ color: 'var(--zen-charcoal)' }}>2pm - 4pm</span>
                </div>
                <div className="flex justify-between">
                  <span style={{ color: 'var(--zen-charcoal-light)' }}>Response rate</span>
                  <span style={{ color: 'var(--zen-charcoal)' }}>87%</span>
                </div>
                <div className="flex justify-between">
                  <span style={{ color: 'var(--zen-charcoal-light)' }}>Avg. response time</span>
